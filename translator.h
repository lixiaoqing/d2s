...
class SentenceTranslator
{
	...
	private:
		...
		void generate_cand_with_btg_rule_and_add_to_pq(int span_lhs,vector<vector<Cand*> > &cands_of_src_nt_leaves, vector<int> &cand_rank_vec,Candpq &candpq_merge,set<vector<int> > &duplicate_set);
