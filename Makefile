...
all: d2s
d2s: main.o maxent.o translator.o lm.o ruletable.o vocab.o cand.o myutils.o syntaxtree.o $(objs)
	$(CXX) -o d2s main.o maxent.o translator.o lm.o ruletable.o vocab.o myutils.o cand.o syntaxtree.o $(objs) $(CXXFLAGS)
ruletable2bin: ruletable2bin.o myutils.o
	$(CXX) -o ruletable2bin ruletable2bin.o myutils.o $(CXXFLAGS)

main.o: translator.h stdafx.h cand.h vocab.h ruletable.h lm.h myutils.h syntaxtree.h maxent.h
translator.o: translator.h stdafx.h cand.h vocab.h ruletable.h lm.h myutils.h syntaxtree.h maxent.h
